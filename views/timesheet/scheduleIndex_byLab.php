...
if ($thisUser->is_supervisor()) {
	$schHelp = '<img src="/LibServices/assets/ess_assets/img/helpICO.png" style="display:none;" class="helpMenu" data-what-help="sch_table" />';
	$navSchHelp = '<img src="/LibServices/assets/ess_assets/img/helpICO.png" style="display:none;" class="helpMenu float-center" data-what-help="sch_upperNav" />';
}

$data['header'] = array();
$data['header'][0] = array(0, 'i'); //hidden for employees
		...
		<div class="row">
			<div class="large-10 medium-12 small-9 small-centered medium-centered columns">
				<div class="row">
					...
					<div id="schSortContainer" class="large-4 small-4 columns">
						<select onchange="if (this.value) window.location.href=this.value">
							<option value="">Sort By...</option>
							<option value="<?= site_url('/timesheet/scheduleIndex/' . $week[DayInWeek::Sunday]); ?>">Employee</option>
						</select>
					</div>

					<div id="schTodayContainer" class="nowrap large-3 small-4 columns">
						<?= anchor('/timesheet/scheduleLabIndex/' . date('Y-m-d'), 'This Week', 'id="todayButton" class="button"'); ?>
					</div>
...
<div id="outerContainer">
	...
	<div class="row">
			...
			<div class="row">
				...
				<div class="large-7 medium-12 small-12 large-centered medium-centered columns">
					...
					<div id="prevContainer" class="small-1 columns">
						<a href="<?= site_url('/timesheet/scheduleLabIndex/' . $lastWeekDate->format('Y-m-d')); ?>">
					...
					<div id="nextContainer" class="small-1 columns">
						<a href="<?= site_url('/timesheet/scheduleLabIndex/' . $nextWeekDate->format('Y-m-d')); ?>">
		...
		<div class="row">
			<div class="small-12 columns"><?= $schHelp ?>
