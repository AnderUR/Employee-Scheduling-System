...
$data['header'][1] = array(250, 'Employee'); 
                ...
                <div class="row">
                    ...
                    <div id="schSortContainer" class="small-4 columns">
                        <select onchange="if (this.value)
                            ...
                            <option value="<?= site_url('/timesheet/scheduleLabIndex/'.$week[DayInWeek::Sunday]); ?> ">Area</option>
                        </select>
                    </div>

                    <div id="schTodayContainer" class="nowrap large-3 small-4 columns">
                      <?=anchor('/timesheet/scheduleIndex/'.date('Y-m-d'), 'This Week', 'id="todayButton" class="button"');?>
                    </div>
            ...
            <div class="row">
                ...
                <div class="large-7 medium-12 small-12 large-centered medium-centered columns">
                    ...
                    <div id="prevContainer" class="small-1 columns">
                        <a href="<?= site_url('/timesheet/scheduleIndex/'.$lastWeekDate->format('Y-m-d')); ?>">
                    ...
                    <div id="nextContainer" class="small-1 columns">
                      <a href="<?= site_url('/timesheet/scheduleIndex/'.$nextWeekDate->format('Y-m-d')); ?>">
